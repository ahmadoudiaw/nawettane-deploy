...
class _ContactScreenState extends State<ContactScreen> {
  ...
  // Strips formatting and ensures full international format for wa.me.
  // Handles: spaces, dashes, parentheses, leading +, Senegal local numbers.
  String _normalizeWhatsAppPhone(String phone) {
    // Remove all non-digit characters
    String digits = phone.replaceAll(RegExp(r'[^\d]'), '');

    // Local Senegalese mobile starting with 7x (e.g. 77, 78, 76, 75, 70)
    if (digits.length == 9 && digits.startsWith('7')) {
      return '221$digits';
    }
    // Local with leading 0 (e.g. 077...)
    ...
    // Already international (starts with country code, no +)
    return digits;
  }
